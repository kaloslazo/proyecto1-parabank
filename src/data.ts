...
export const clientRequirements: ClientRequirement[] = [
  ...
  { id: 'RF-22', functionalityId: 'F-08', requirement: 'El panel debe permitir seleccionar el proveedor y procesador de préstamos disponibles.', actor: 'Administrador', dataRules: 'Opciones válidas de Loan Provider y Loan Processor.', expected: 'La selección queda disponible para la configuración del banco.', priority: 'Media' },
]
...
export const initialCases: TestCase[] = [
  ...
  { id: 'CP-LOAN-01', requirement: 'RF-07', feature: 'Préstamos', condition: 'Solicitar un préstamo con enganche suficiente para aprobación.', priority: 'Media', technique: 'Tablas de decisión y gráficos causa-efecto', preconditions: 'Cliente autenticado y formulario disponible.', data: 'Monto solicitado y down payment que cumpla el umbral configurado.', steps: ['Abrir Request Loan', 'Ingresar monto y enganche', 'Enviar'], expected: 'El sistema muestra una aprobación explícita.', status: 'Pendiente', evidence: false },
  { id: 'CP-LOAN-02', requirement: 'RF-07', feature: 'Préstamos', condition: 'Solicitar un préstamo con enganche insuficiente.', priority: 'Media', technique: 'Análisis de valores límite', preconditions: 'Cliente autenticado.', data: 'Down payment por debajo del umbral.', steps: ['Abrir Request Loan', 'Ingresar monto y enganche insuficiente', 'Enviar'], expected: 'El sistema muestra un rechazo explícito y no aprueba el préstamo.', status: 'Pendiente', evidence: false },
  { id: 'CP-PROF-01', requirement: 'RF-08', feature: 'Perfil', condition: 'Actualizar datos de contacto y comprobar persistencia.', priority: 'Media', technique: 'Pruebas de caso de uso', preconditions: 'Cliente autenticado.', data: 'Teléfono y dirección ficticios válidos.', steps: ['Abrir Update Contact Info', 'Modificar los datos', 'Guardar', 'Salir y volver al perfil'], expected: 'Los datos actualizados permanecen visibles en el perfil.', status: 'Pendiente', evidence: false },
  { id: 'CP-NFR-01', requirement: 'RNF-01', feature: 'Rendimiento', condition: 'Medir el tiempo de respuesta de una transferencia o pago.', priority: 'Media', technique: 'Pruebas estadísticas', preconditions: 'Cuenta de prueba y cronómetro disponibles.', data: 'Transacción válida de bajo monto.', steps: ['Iniciar cronómetro al enviar', 'Detener al recibir confirmación', 'Registrar el tiempo'], expected: 'La confirmación llega en menos de 3 segundos.', status: 'Pendiente', evidence: false },
  { id: 'CP-NFR-02', requirement: 'RNF-02', feature: 'Sesión', condition: 'Verificar el comportamiento después de inactividad.', priority: 'Media', technique: 'Tablas de decisión y gráficos causa-efecto', preconditions: 'Sesión iniciada; ventana de inactividad definida por el entorno.', data: 'Sin interacción durante el intervalo observado.', steps: ['Iniciar sesión', 'No interactuar', 'Intentar abrir una función protegida'], expected: 'La sesión se cierra y el sistema exige autenticación nuevamente.', status: 'Pendiente', evidence: false },
]
